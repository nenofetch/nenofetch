...
def main():
    ...
    t.gen_text("Copyright (C) 2023, \x1b[31mnenofetch Softwares Inc.\x1b[0m", 2)
    ...
    t.toggle_show_cursor(True)
    t.gen_typing_text("nenofetch", 3, contin=True)
    ...
    git_user_details = gifos.utils.fetch_github_stats("nenofetch", ignore_repos)
    user_age = gifos.utils.calc_age(26, 7, 2002)
    t.clear_frame()
    top_languages = [lang[0] for lang in git_user_details.languages_sorted]
    user_details_lines = f"""
    \x1b[30;101mnenofetch@GitHub\x1b[0m
    --------------
    \x1b[96mOS:     \x1b[93mArch/Fedora Linux, Windows 11, Android 14\x1b[0m
    ...
    --------------
    \x1b[96mEmail:      \x1b[93mnenoarisma@gmail.com\x1b[0m
    \x1b[96mLinkedIn:   \x1b[93mnenoarisma\x1b[0m
    ...
    t.gen_typing_text(" -u nenofetch", 1, contin=True)
    ...
    t.toggle_show_cursor(True)
    # t.pasteImage("./temp/nenofetch.jpg", 3, 5, sizeMulti=0.5)
